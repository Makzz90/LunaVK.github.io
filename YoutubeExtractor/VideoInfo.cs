...
namespace YoutubeExtractor
{
    public class VideoInfo
    {
        ...
        internal static IEnumerable<VideoInfo> Defaults = new List<VideoInfo>
        {
            ...
            // Video only
            new VideoInfo(133, VideoType.Mp4, 240, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(134, VideoType.Mp4, 360, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(135, VideoType.Mp4, 480, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(136, VideoType.Mp4, 720, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(137, VideoType.Mp4, 1080, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(138, VideoType.Mp4, 2160, false, AudioType.None, 0, AdaptiveType.Video),

            new VideoInfo(160, VideoType.Mp4, 144, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(242, VideoType.WebM, 240, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(243, VideoType.WebM, 360, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(244, VideoType.WebM, 480, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(247, VideoType.WebM, 720, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(248, VideoType.WebM, 1080, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(264, VideoType.Mp4, 1440, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(271, VideoType.WebM, 1440, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(272, VideoType.WebM, 2160, false, AudioType.None, 0, AdaptiveType.Video),
            new VideoInfo(278, VideoType.WebM, 144, false, AudioType.None, 0, AdaptiveType.Video),

            new VideoInfo(313, VideoType.WebM, 2160, false, AudioType.None, 0, AdaptiveType.Video),
            ...
            new VideoInfo(249, VideoType.WebM, 0, false, AudioType.Aac, 50, AdaptiveType.Audio),
            new VideoInfo(250, VideoType.WebM, 0, false, AudioType.Aac, 70, AdaptiveType.Audio),
            new VideoInfo(251, VideoType.WebM, 0, false, AudioType.Aac, 160, AdaptiveType.Audio),
        };
        ...
        public override string ToString()
        {
            ...
            return string.Format("Type: {0}, Resolution: {1}p, AudioType: {2}, AudioExtension {3}", this.VideoType, this.Resolution, this.AudioType, this.AudioExtension);
        }
    }
}