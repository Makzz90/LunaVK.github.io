...
namespace LunaVK.UC.Controls
{
    ...
    public class RadialProgressBar : ProgressBar
    {
        ...
        protected override void OnValueChanged(double oldValue, double newValue)
        {
            ...
            VisualStateManager.GoToState(this, newValue > 0 && newValue < base.Maximum ? "Active" : "Inactive", true);
        }
        ...
        private double ComputeNormalizedRange()
        {
            ...
            output = Math.Min(Math.Max(0.03, output), 0.9999);//output = Math.Min(Math.Max(0.0, output), 0.9999);
            return output;
        }
