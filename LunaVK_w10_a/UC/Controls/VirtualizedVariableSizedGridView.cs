...
namespace LunaVK.UC.Controls
{
    ...
    public class VirtualizedVariableSizedWrapGrid : Control
    {
        ...
        public static DependencyProperty ItemHeightProperty = DependencyProperty.Register("ItemHeight", typeof(double), typeof(VirtualizedVariableSizedWrapGrid), new PropertyMetadata(0d, ItemHeightPropertyChanged));
        public static DependencyProperty ItemWidthProperty = DependencyProperty.Register("ItemWidth", typeof(double), typeof(VirtualizedVariableSizedWrapGrid), new PropertyMetadata(0d, ItemWidthPropertyChanged));

        private List<ItemContainer> _itemContainer;

        /// <summary>
        /// Это сетка внутри ScrollViewer
        /// </summary>
        ...
        {
            base.DefaultStyleKey = typeof(VirtualizedVariableSizedWrapGrid);
            this.Style = (Style)XamlReader.Load(
                @"<Style xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml' xmlns:controls='using:LunaVK.UC.Controls' TargetType='controls:VirtualizedVariableSizedWrapGrid'>
